...
- `2026-09-12-batch-112-116` / 기준 `ac3a5967d73ac4fa9ee4c651dd7e0e6a6761455b` / 범위 `remaining/112/001.json`~`remaining/116/001.json` 전체 5묶음 / 상태 `진행 중` / 결과 `proposals/2026-09-12-batch-112-116.json` / 다음 시작점·보류: 과거 bulk 110-150 제안의 112~116 판단을 현재 remaining·taxonomy·accepted·수동결정과 재검증 중. 분류 외 promotion/quantity/unit 문제는 별도 보존.
