...
- `2026-09-12-tube-icecream-110` / 기준 `f69b89ba11ef383ddd118cc1f41d73b6f250a50a` / 범위 `remaining/110/001.json` 전체 / 상태 `진행 중` / 결과 `proposals/2026-09-12-tube-icecream-110.json` / 다음 시작점·보류: 9관측/9상품의 튜브 아이스크림 묶음. 현재 taxonomy에 정확 리프가 없어 신규 리프 검토 후보로 재검증 중이며 promotion_unresolved는 별도 보류 유지.
