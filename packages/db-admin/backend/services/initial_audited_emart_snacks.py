...
GROUPS={
 ...
 'food.snacks.baked.biscuits': ('초코칩쿠키 256G','오트 초코칩쿠키 208g','옹골진 오곡쿠키 288g','닥터유 다이제씬 252g','해태 에이스 씬 쏠티카라멜 291g','해태 버터링딥초코155g'),
 ...
 'food.snacks.savory.potato': ('감자칩오리지날 160g','포카칩 소금 66g','포카칩 오리지널 137g','포카칩 어니언맛 66g','스윙칩 볶음고추장 124g'),
 'food.snacks.savory.vegetable': ('자색고구마칩 160 g',),
 'food.snacks.savory.grain': ('한입쌀과자 250g','참쌀선과 253g'),
 'food.snacks.savory.wheat': ('라면스낵 250g',),
 'food.snacks.savory.popcorn': ('팝콘 버터솔트맛 80g',),
 'food.snacks.savory.corn': ('도도한나쵸 155g','고르곤졸라치즈소프트콘 150 g','롯데 꼬깔콘 군옥수수 67g','신상 롯데 꼬깔콘 애플시나몬 75g'),
 ...
 'food.snacks.baked.cake': ('참붕어빵 8입 232g(패키지 랜덤 발송)',),
 'food.snacks.cereal.chocolate': ('오레오오즈 컵 30g',),
 'food.snacks.sweets.candy': ('스톡 리젠 초코토피 150g',),
 'food.frozen.dessert.ice_cream': ('X복순도가 쌀젤라또 474ml',),
}
