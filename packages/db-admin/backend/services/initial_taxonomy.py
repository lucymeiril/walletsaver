...
from services.initial_numbered_reviews import reviewed_numbered_leaf
...
def classify_record(record: Mapping[str, Any]) -> dict[str, Any]:
    ...
    costco_snack_form_leaf = reviewed_costco_snack_form_leaf(evidence)
    if costco_snack_form_leaf:
        homeplus_shelf_ids.add(costco_snack_form_leaf)
    emart_dairy_leaf = reviewed_emart_dairy_leaf(evidence)
    if emart_dairy_leaf:
        homeplus_shelf_ids.add(emart_dairy_leaf)
    ...
    emart_seafood_leaf = reviewed_emart_seafood_leaf(evidence)
    if emart_seafood_leaf:
        homeplus_shelf_ids.add(emart_seafood_leaf)
