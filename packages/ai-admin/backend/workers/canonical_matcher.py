    ...
    def process(self, batch: AIJobBatch) -> AIWorkerOutput:
                    ...
                    alternatives=[
                        {
                            ...
                            "trust_label": "raw_title_normalization_not_generalization",
                        }
                    ],
                ...
                alias_proposals.append(
                    make_proposal(
                        ...
                        alternatives=[
                            {
                                "evidence_class": "deterministic_raw",
                                "trust_label": "raw_title_alias_not_learned_reuse",
                            }
                        ],
        ...
        return AIWorkerOutput(
            ...
            diagnostics={
                ...
                "trust_label": "deterministic_raw_title_drafts_require_review",
            },
        )
