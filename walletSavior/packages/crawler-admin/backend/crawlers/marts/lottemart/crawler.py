...
롯데마트 행사 상품 페이지에서 전단지/할인 데이터를 수집한다.
롯데마트는 행사 상품 목록을 내부 API(JSON) 또는 SSR HTML로 제공하므로
...
class LottemartCrawler(CrawlerContract):
    ...
    async def crawl(self) -> CrawlResult:
        ...
        try:
            ...
            headers.update({
                "Referer": "https://www.lottemart.com/",
